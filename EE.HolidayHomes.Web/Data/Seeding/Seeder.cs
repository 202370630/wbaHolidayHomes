...
namespace EE.HolidayHomes.Web.Data.Seeding
{
    public static class Seeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            {
                new HolidayHome{Id = 1,Name = "The Villa",Price = 120.50M,Image = "house1.jpg",LocationId = 1},
                new HolidayHome{Id = 2,Name = "The Cottage",Price = 250.55M,Image = "house2.jpg", LocationId = 2},
                new HolidayHome{Id = 3,Name = "The farmhouse",Price = 350.50M,Image = "house3.jpg", LocationId = 3},
                new HolidayHome{Id = 4,Name = "The seaside house",Price = 350.55M,Image = "house4.jpg", LocationId = 4},
            };
